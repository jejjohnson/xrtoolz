...
from xrreader import CDSCredentials, CDSSource, describe
from xrreader._src.cache import _json_default
from xrreader._src.cds.source import _engine_for_format, _suffix_for_format
from xrreader.types import BBox, TimeRange, Variable, apply_cf_attrs
...
def test_describe_returns_dataset_info_not_any():
    from xrreader import DatasetInfo
...
def test_validation_range_check_handles_empty_data_without_raising():
    ...
    from xrreader.types import validate_variable
