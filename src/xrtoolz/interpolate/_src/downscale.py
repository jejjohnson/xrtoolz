...
:class:`~xrtoolz.inference.modelop.ModelOp`, any other
:class:`~pipekit.Operator`, or a plain callable that maps an
...
class Downscale(_ResolutionOp):
    ...
    counterpart in :mod:`xrtoolz.interpolate._src.grid_to_grid`.
    """
