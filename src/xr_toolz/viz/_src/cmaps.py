...
name (or :class:`xr_toolz.types.Variable` instance) by reading the
``cmap`` field on entries of the curated
:data:`xr_toolz.types.REGISTRY`. Falls back to ``default`` (default
...
from xr_toolz.types._src.variable import REGISTRY, Variable
