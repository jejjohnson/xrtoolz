...
[`Variable`](../../packages/xrtoolz-reader/src/xrreader/types/_src/variable.py) registry —
...
|---|---|---|
| `Variable` registry with `standard_name` field | [`xrreader/types/_src/variable.py`](../../packages/xrtoolz-reader/src/xrreader/types/_src/variable.py) — 78+ entries | reuse |
